...
Pod::Spec.new do |s|
  s.name             = 'rk_pki'
  s.version          = '0.4.0'
  s.summary          = 'Certificates, mutual TLS and a per-installation certificate authority.'
  s.description      = <<-DESC
Native part of the rk_pki Dart package. Rust behind a C ABI, linked into the
pod framework so `dart:ffi` can open it as rk_pki.framework/rk_pki.
                       DESC
  s.homepage         = 'https://github.com/0101001001001011/rk-pki'
  ...
  s.script_phase = {
    ...
    :output_files => ['${BUILT_PRODUCTS_DIR}/librk_pki.a'],
  }
  ...
  s.pod_target_xcconfig = {
    ...
    # которой нет.
    'OTHER_LDFLAGS' => '-force_load ${BUILT_PRODUCTS_DIR}/librk_pki.a',
  }
  s.swift_version = '5.0'
end
